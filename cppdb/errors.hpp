#ifndef CPPDB_ERRORS_HPP
#define CPPDB_ERRORS_HPP
...
public:
	...
	///
	not_supported_by_backend(const std::string &e) : cppdb_error(e) {}
};

} // namespace cppdb

#endif /* CPPDB_ERRORS_HPP */
