#ifndef CPPDB_BACKEND_HPP
#define CPPDB_BACKEND_HPP
...
public:
	...
	///
	virtual int name_to_column(const std::string &) = 0;
	///
...
public:
	...
	/// caching
	///
	virtual const std::string &sql_query() = 0;
	...
	/// support from back-end.
	///
	virtual void bind(int col, const std::tm &) = 0;
	///
	...
	///
	virtual long long sequence_last(const std::string &sequence) = 0;
	///
...
public:
	...
	/// Escape a string for inclusion in SQL query. May throw not_supported_by_backend() if not supported by backend.
	///
	virtual std::string escape(const char *s) = 0;
	///
	/// Escape a string for inclusion in SQL query. May throw not_supported_by_backend() if not supported by backend.
	///
	virtual std::string escape(const char *b, const char *e) = 0;
	///
