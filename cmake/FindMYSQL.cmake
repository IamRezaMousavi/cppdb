# Once done this will define: MYSQL_FOUND                     - If false, do not try to use MySQL. MYSQL_INCLUDE_DIRS -
# Where to find mysql.h, etc. MYSQL_LIBRARIES         - The libraries to link against. MYSQL_VERSION_STRING - Version in
# a string of MySQL.
#
...
if(WIN32)
  find_path(
    MYSQL_INCLUDE_DIR
    NAMES "mysql.h"
    PATHS "$ENV{PROGRAMFILES}/MySQL/*/include" "$ENV{PROGRAMFILES(x86)}/MySQL/*/include"
          "$ENV{SYSTEMDRIVE}/MySQL/*/include")

  find_library(
    MYSQL_LIBRARY
    NAMES "mysqlclient" "mysqlclient_r"
    PATHS "$ENV{PROGRAMFILES}/MySQL/*/lib" "$ENV{PROGRAMFILES(x86)}/MySQL/*/lib" "$ENV{SYSTEMDRIVE}/MySQL/*/lib")
else()
  find_path(
    MYSQL_INCLUDE_DIR
...
if(MYSQL_FOUND)
  ...
  if(NOT TARGET MYSQL::MYSQL)
    ...
    set_target_properties(MYSQL::MYSQL PROPERTIES IMPORTED_LOCATION "${MYSQL_LIBRARY}" INTERFACE_INCLUDE_DIRECTORIES
                                                                                       "${MYSQL_INCLUDE_DIR}")
  endif()
endif()
